"""
Django settings for spa-proof-of-concept project.
...
PROJECT_NAME = "spa_proof_of_concept"
# Shown in error pages and some other places
PROJECT_TITLE = "spa-proof-of-concept"
...
MANAGERS = ADMINS
EMAIL_SUBJECT_PREFIX = "[spa-proof-of-concept] "  # subject prefix for managers & admins
...
DATABASES = {
    ...
    "default": env.dj_db_url(
        ...
        default="postgres://{user}:{password}@{host}:{port}/{name}?sslmode={sslmode}".format(
            ...
            name=quote(env.str("DJANGO_DATABASE_NAME", default="spa_proof_of_concept")),
            user=quote(env.str("DJANGO_DATABASE_USER", default="spa_proof_of_concept")),
            password=quote(
                env.str("DJANGO_DATABASE_PASSWORD", default="spa_proof_of_concept"),
            ),
...
HEALTH_CHECK_ACCESS_TOKEN = env.str(
    "DJANGO_HEALTH_CHECK_ACCESS_TOKEN",
